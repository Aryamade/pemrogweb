        ...
        <div class="card-body">
            ...
            <form method="post" action="<?= base_url('anggota/update/' . $anggota->id_anggota) ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?=$anggota->tempat_lahir; ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="alamat" id="alamat"><?= $anggota->alamat; ?></textarea>
                </div>
                <div class="form-group">
